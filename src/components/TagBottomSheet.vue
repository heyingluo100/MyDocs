          ...
          <nav class="flex-1 overflow-y-auto px-4 pb-6 space-y-1">
            ...
            <template v-if="allCollections.length">
              ...
              <router-link
                ...
                @click="close"
                class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-all duration-300 text-linear-text-secondary hover:bg-linear-bg-tertiary hover:text-linear-text"
              >
                <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
